...
var o__38936__auto___40588 = (function (){var o__38936__auto__ = (function (){var o__38936__auto__ = Promise;
return goog.object.get(o__38936__auto__,"resolve").call(o__38936__auto__);
})();
return goog.object.get(o__38936__auto__,"then").call(o__38936__auto__,callback);
})();
goog.object.get(o__38936__auto___40588,"catch").call(o__38936__auto___40588,devtools.async.rethrow_outside_promise);
...
var G__40590_40591 = Error;
var target__38955__auto___40592 = G__40590_40591;
if(cljs.core.truth_(target__38955__auto___40592)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__40590_40591)].join('')),cljs.core.str("\n"),cljs.core.str("target__38955__auto__")].join('')));
}

goog.object.set(target__38955__auto___40592,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1485300139815