...
var args40327 = [];
var len__25865__auto___40333 = arguments.length;
var i__25866__auto___40334 = (0);
while(true){
if((i__25866__auto___40334 < len__25865__auto___40333)){
args40327.push((arguments[i__25866__auto___40334]));

var G__40335 = (i__25866__auto___40334 + (1));
i__25866__auto___40334 = G__40335;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox40330 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox40330 = (function (obj,header,style,tag,meta40331){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox40330.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40332,meta40331__$1){
var self__ = this;
var _40332__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox40330(self__.obj,self__.header,self__.style,self__.tag,meta40331__$1));
});

devtools.toolbox.t_devtools$toolbox40330.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40332){
var self__ = this;
var _40332__$1 = this;
return self__.meta40331;
});

devtools.toolbox.t_devtools$toolbox40330.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox40330.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40330.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox40330.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40330.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta40331","meta40331",-147178181,null)], null);
});

devtools.toolbox.t_devtools$toolbox40330.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox40330.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox40330";

devtools.toolbox.t_devtools$toolbox40330.cljs$lang$ctorPrWriter = (function (this__25396__auto__,writer__25397__auto__,opt__25398__auto__){
return cljs.core._write.call(null,writer__25397__auto__,"devtools.toolbox/t_devtools$toolbox40330");
});

devtools.toolbox.__GT_t_devtools$toolbox40330 = (function devtools$toolbox$__GT_t_devtools$toolbox40330(obj__$1,header__$1,style__$1,tag__$1,meta40331){
return (new devtools.toolbox.t_devtools$toolbox40330(obj__$1,header__$1,style__$1,tag__$1,meta40331));
});

}

return (new devtools.toolbox.t_devtools$toolbox40330(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1485300138606