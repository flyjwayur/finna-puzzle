...
var map__40615 = top_item;
var map__40615__$1 = ((((!((map__40615 == null)))?((((map__40615.cljs$lang$protocol_mask$partition0$ & (64))) || (map__40615.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40615):map__40615);
var file = cljs.core.get.call(null,map__40615__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40615__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40615__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40614){var _e = e40614;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___40617 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___40617)){
var seen_errors_40618 = temp__4655__auto___40617;
if(cljs.core.truth_(seen_errors_40618.has(self))){
} else {
seen_errors_40618.add(self);

var temp__4657__auto___40619 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___40619)){
var sense_40620 = temp__4657__auto___40619;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_40620)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1485300140280